...
Ιδρύεται Σωματείο, μη κερδοσκοπικό, με την επωνυμία "Σωματείο GreeceJS" και με έδρα το Δήμο Αθηναίων.
...
Η συμμετοχή στη Γενική Συνέλευσης και η ψηφοφορία είναι δυνατό να γίνει και εξ αποστάσεως με ηλεκτρονικά μέσα χωρίς τη φυσική παρουσία των μελών στον τόπο διεξαγωγής της Γενικής Συνέλευσης. Σε αυτή την περίπτωση τα μέλη που θα συμμετέχουν και θα ψηφίζουν εξ αποστάσεως θα πρέπει να βεβαιώνουν την επιλογή τους για συμμετοχή εξ αποστάσεως με δήλωσή τους προς το Διοικητικό Συμβούλιο του Σωματείου. 
